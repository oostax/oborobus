...
# Use spawn on all platforms to avoid fork() issues on macOS with Objective-C
# (NSNumber initialize crashes). Windows only supports "spawn" anyway.
_DEFAULT_WORKER_START_METHOD = "spawn"
